...
def gettytul():
    return 'http://www.filma24hd.cc/'   # old domain : http://www.filma24hd.com/ 

class Filma24hdCom(CBaseHostClass):
    MAIN_URL = 'http://www.filma24hd.cc/'
    SRCH_URL = MAIN_URL + '?s='
    DEFAULT_ICON_URL = 'http://www.filma24hd.cc//wp-content/uploads/2015/12/f24hd.png'
    MAIN_TV_SERIES_URL = 'http://seriale.filma24hd.cc/'
    DEFAULT_TV_SERIES_ICON_URL = 'http://seriale.filma24hd.cc/wp-content/uploads/2015/12/f24hdserie.png'
    MAIN_CAT_TAB = [{'category': 'movies', 'title': _('Movies'), 'url': MAIN_URL, 'icon': DEFAULT_ICON_URL}, {'category': 'series', 'title': _('TV Series'), 'url': MAIN_TV_SERIES_URL, 'icon': DEFAULT_TV_SERIES_ICON_URL}, {'category': 'search', 'title': _('Search'), 'search_item': True, 'icon': DEFAULT_ICON_URL}, {'category': 'search_history', 'title': _('Search history'), 'icon': DEFAULT_ICON_URL}]
...
class IPTVHost(CHostBase):
    ...
    def converItem(self, cItem):
        ...
        icon = cItem.get('icon', '')
        return CDisplayListItem(name=title, description=description, type=type, urlItems=hostLinks, urlSeparateRequest=1, iconimage=icon, possibleTypesOfSearch=possibleTypesOfSearch)
