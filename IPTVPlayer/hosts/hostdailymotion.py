...
config.plugins.iptvplayer.dailymotion_localization = ConfigSelection(default='auto', choices=[('auto',_('auto')), ('ar_AA', 'Ø§ÙØ¹Ø±Ø¨ÙØ©'), ('es_AR', 'Argentina'), ('en_AU', 'Australia'), ('de_AT', 'Ãsterreich'), ('nl_BE', 'BelgiÃ«'), ('fr_BE', 'Belgique'), ('pt_BR', 'Brasil'), ('en_CA', 'Canada'), ('fr_CA', 'Canada'), ('zh_CN', 'ä¸­å½'), ('fr_FR', 'France'), ('de_DE', 'Deutschland'), ('el_GR', 'ÎÎ»Î»Î¬Î´Î±'), ('en_IN', 'India'), ('id_ID', 'Indonesia'), ('en_EN', 'International'), ('en_IE', 'Ireland'), ('it_IT', 'Italia'), ('ja_JP', 'æ¥æ¬'), ('ms_MY', 'Malaysia'), ('es_MX', 'MÃ©xico'), ('fr_MA', 'Maroc'), ('nl_NL', 'Nederland'), ('en_PK', 'Pakistan'), ('en_PH', 'Pilipinas'), ('pl_PL', 'Polska'), ('pt_PT', 'Portugal'), ('ro_RO', 'RomÃ¢nia'), ('ru_RU', 'Ð Ð¾ÑÑÐ¸Ñ'), ('en_SG', 'Singapore'), ('ko_KR', 'ëíë¯¼êµ­'), ('es_ES', 'EspaÃ±a'), ('fr_CH', 'Suisse'), ('it_CH', 'Svizzera'), ('de_CH', 'Schweiz'), ('fr_TN', 'Tunisie'), ('tr_TR', 'TÃ¼rkiye'), ('en_GB', 'United Kingdom'), ('en_US', 'United States'), ('vi_VN', 'Viá»t Nam')])
...
class Dailymotion(CBaseHostClass):
    ...
    def __init__(self):
        ...
        self.MAIN_CAT_TAB = [{'category': 'categories', 'title': _('Categories')}, {'category': 'search', 'title': _('Search'), 'search_item': True}, {'category': 'search_history', 'title': _('Search history')}]
        self.SORT_TAB = [{'title': _('Most viewed'), 'sort': 'visited'}, {'title': _('Most recent'), 'sort': 'recent'}, {'title': _('Most rated'), 'sort': 'rated'}, {'title': _('Ranking'), 'sort': 'ranking'}, {'title': _('Trending'), 'sort': 'trending'}, {'title': _('Random'), 'sort': 'random'}]
        self.filterCache = {}
    ...
    def getLocale(self):
        ...
        if 'auto' != locale:
            return locale
        all = [('ar_AA','Ø§ÙØ¹Ø±Ø¨ÙØ©'), ('es_AR', 'Argentina'), ('en_AU', 'Australia'), ('de_AT', 'Ãsterreich'), ('nl_BE', 'BelgiÃ«'), ('fr_BE', 'Belgique'), ('pt_BR', 'Brasil'), ('en_CA', 'Canada'), ('fr_CA', 'Canada'), ('zh_CN', 'ä¸­å½'), ('fr_FR', 'France'), ('de_DE', 'Deutschland'), ('el_GR', 'ÎÎ»Î»Î¬Î´Î±'), ('en_IN', 'India'), ('id_ID', 'Indonesia'), ('en_EN', 'International'), ('en_IE', 'Ireland'), ('it_IT', 'Italia'), ('ja_JP', 'æ¥æ¬'), ('ms_MY', 'Malaysia'), ('es_MX', 'MÃ©xico'), ('fr_MA', 'Maroc'), ('nl_NL', 'Nederland'), ('en_PK', 'Pakistan'), ('en_PH', 'Pilipinas'), ('pl_PL', 'Polska'), ('pt_PT', 'Portugal'), ('ro_RO', 'RomÃ¢nia'), ('ru_RU', 'Ð Ð¾ÑÑÐ¸Ñ'), ('en_SG', 'Singapore'), ('ko_KR', 'ëíë¯¼êµ­'), ('es_ES', 'EspaÃ±a'), ('fr_CH', 'Suisse'), ('it_CH', 'Svizzera'), ('de_CH', 'Schweiz'), ('fr_TN', 'Tunisie'), ('tr_TR', 'TÃ¼rkiye'), ('en_GB', 'United Kingdom'), ('en_US', 'United States'), ('vi_VN', 'Viá»t Nam')]
    ...
    def listVideos(self, cItem, type='videos'):
        ...
        if type in ('videos', 'playlist', 'channel'):
            args = [
             'thumbnail_ratio=widescreen', ('limit={0}').format(20), ('fields={0}').format(urllib.quote('id,mode,title,duration,views_total,created_time,channel,thumbnail_240_url,url,live_publish_url'))]
