...
class OtakuFR(CBaseHostClass):
    ...
    def __init__(self):
        CBaseHostClass.__init__(self, {'history': 'otakufr.com',
        ...
        self.DEFAULT_ICON_URL = 'http://www.otakufr.com/wp-content/uploads/2015/08/banr-hedr-otakufr.jpg'
        self.MAIN_URL = None
        self.cacheABC = {}
        self.cacheSeries = []
        self.cachePrograms = []
    ...
    def selectDomain(self):
        ...
        self.MAIN_CAT_TAB = [{'category': 'list_abc',
          'title': 'Toute La Liste',
          'url': self.getFullUrl('/anime-list-all/')},
         {'category': 'list_abc',
          'title': 'En Cours',
          'url': self.getFullUrl('/anime-en-cours/')},
         {'category': 'list_rank_items',
          'title': 'Populaire',
          'url': self.getFullUrl('/anime-list/all/any/most-popular/')},
         {'category': 'list_abc',
          'title': 'Termin\xc3\xa9',
          'url': self.getFullUrl('/anime-termine/')},
         {'category': 'list_rank_items',
          'title': 'Film',
          'url': self.getFullUrl('/anime-list/tag/Film/')},
         {'category': 'search',
          'title': _('Search'),
          'search_item': True},
        ...
        for section in data:
            ...
            if len(itemsTab):
                ...
                params.update({'good_for_fav': False,
                 ...
                 'title': sectionTitle + ' [%s]' % len(itemsTab),
                 'abc_key': sectionTitle})
                self.addDir(params)
    ...
    def listLast(self, cItem, nextCategory):
        ...
        for section in data:
            ...
            for item in section:
                ...
                itemsTab.append({'good_for_fav': True,
                 'title': title,
                 'url': url,
                 'icon': icon,
                 'desc': desc})
    ...
    def listSearchResult(self, cItem, searchPattern, searchType):
        ...
        post_data = {'txt_wpa_wgt_anm_sch_nme': searchPattern,
         'cmd_wpa_wgt_anm_sch_sbm': 'Search'}
    ...
    def getLinksForVideo(self, cItem):
        ...
        for item in data:
            ...
            if not self.cm.isValidUrl(playerUrl):
                continue
            urlTab.append({'name': self.cleanHtmlStr(item),
             'url': playerUrl,
             'need_resolve': 1})
