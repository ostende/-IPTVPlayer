...
class Host:
    ...
    def getInitList(self):
        ...
        _url = 'https://gitlab.com/9thprince/infoversion/raw/master/hosts/hostinfoversion.py'
...
#        self.USER_AGENT = 'Mozilla/5.0 (iPhone; CPU iPhone OS 5_0 like Mac OS X) AppleWebKit/534.46 (KHTML, like Gecko) Version/5.1 Mobile/9A334 Safari/7534.48.3'
    ...
    def listsItems(self, Index, url, name = ''):
        ...
        if name == 'main-menu':
           ...
           valTab.insert(0,CDisplayListItem('Info o E2iPlayer - fork 9thprince', 'Wersja hostinfoversion: '+self.infoversion, CDisplayListItem.TYPE_CATEGORY, ['https://gitlab.com/9thprince/e2iplayer/commits/master.atom'], 'info', Image, None)) 
           valTab.insert(0,CDisplayListItem('Info o E2iPlayer - fork rgysoft', 'Wersja hostinfoversion: '+self.infoversion, CDisplayListItem.TYPE_CATEGORY, ['https://gitlab.com/rgysoft/iptv-host-e2iplayer/commits/master.atom'], 'info', Image, None))
           valTab.insert(0,CDisplayListItem('Info o E2iPlayer - fork 9thprince', 'Wersja hostinfoversion: '+self.infoversion, CDisplayListItem.TYPE_CATEGORY, ['https://gitlab.com/9thprince/tsiplayervod/commits/master.atom'], 'info', Image, None)) 
           ...
           if config.plugins.iptvplayer.infoupdate.value:
               valTab.append(CDisplayListItem('ZMIANY W WERSJI',                    'ZMIANY W WERSJI',   CDisplayListItem.TYPE_CATEGORY, ['https://gitlab.com/9thprince/infoversion/commits/master.atom'], 'UPDATE-ZMIANY', '', None)) 
...
#############################################
        ...
        if 'info' == name:
            ...
            for item in data:
                ...
                valTab.append(CDisplayListItem(Updated+' '+Name+'  >>  '+decodeHtml(Title),decodeHtml(Title),CDisplayListItem.TYPE_CATEGORY, [''],'', '', None)) 
            if '9thprince' in url:
                Url = 'https://gitlab.com/9thprince/e2iplayer' 
            elif 'zadmario' in url:
                Url = 'https://gitlab.com/zadmario/e2iplayer'
            elif 'maxbambi' in url:
                Url = 'https://gitlab.com/maxbambi/e2iplayer'
            elif 'mosz_nowy' in url:
                Url = 'https://gitlab.com/mosz_nowy/e2iplayer'
            elif '9thprince' in url:
                Url = 'https://gitlab.com/Rgysoft/iptv-host-e2iplayer'
            elif 'rgysoft' in url:
                Url = 'https://gitlab.com/9thprince/tsiplayervod'           
            else:
        ...
        if 'UPDATE-NOW' == name:
           ...
           import os
           _url = 'https://gitlab.com/9thprince/infoversion'
           ...
           _url = 'https://gitlab.com/9thprince/infoversion/repository/master/archive.tar.gz?ref=master'              
